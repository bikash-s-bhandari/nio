...
<link rel="stylesheet" href="<?php echo base_url();?>assets/dist/css/jquery.Jcrop.min.css" type="text/css" />
...
<body>
    ...
    <div id="popup_upload">
        <div class="form_upload">
            ...
            <h2>Upload photo</h2>
            <form action="<?php echo base_url();?>Crop/upload_file" method="post" enctype="multipart/form-data" target="upload_frame" onsubmit="submit_photo()">
